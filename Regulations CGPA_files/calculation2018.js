$(document).ready(function() {
    ...
    function a() {
        ...
        $("#gpa").find("tr").each(function() {
            ...
            ("O" == l || "o" == l || "10" == l) && (l = 10), ("a+" == l || "A+" == l || "9" == l) && (l = 9), ("A" == l || "a" == l || "8" == l) && (l = 8), ("b+" == l || "B+" == l || "7" == l) && (l = 7), ("b" == l || "B" == l || "6" == l) && (l = 6), ("c" == l || "C" == l || "5" == l) && (l = 5), ("p" == l || "P" == l || "4" == l) && (l = 4);
            var n = d * l;
    ...
    function i() {
        var t = $("<tr class='calculation visible'><td>" + (d + 2) + "</td><td><div class='row'><div class='credit input-field col s12'><input class='credit' type='text' tabIndex='" + l++ + "' id='" + (d + 1) + "Credits'><label for='" + (d + 1) + "Credits'>Credits</label></div></div></td><td><div class='row'><div class='grade input-field col s12'><input class='grade' maxlength='2' type='text' tabIndex='" + l++ + "' id='" + (d + 1) + "Grade'><label for='" + (d + 1) + "Grade'>Grade</label></div></div></td></tr>");
        $("#gpatable").append(t), d++
    }
